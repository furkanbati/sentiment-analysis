...
Preprocessing: Automatically cleans HTML tags, removes special characters, and normalizes text.

Interactive UI: Built with Streamlit for a clean and user-friendly experience.

ML Model: Uses Scikit-Learn’s TF-IDF Vectorization and Logistic Regression for high-accuracy classification.
